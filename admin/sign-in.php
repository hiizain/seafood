              ...
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  ...
                  if(isset($_GET['pesan'])){
                    ...
                    <div class="alert alert-success alert-dismissible fade show" role="alert">Sign In Gagal!
                    </div>
                ...
                if(isset($_GET['pesan'])){
                  if($_GET['pesan'] == "gagal"){
                    ...
                    echo "You must login to access the admin page";
                  }
                }
                ?>
                <div class="card-body">
                  <form method="POST" action="process/sign-in.php" role="form" class="text-start">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      ...
                      <input type="pass" class="form-control" name="pass" minlength="8" required>
                    </div>
            ...
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-12 col-md-6 my-auto">
                <div class="copyright text-center text-sm text-white text-lg-start">
                  ...
                  <strong><span>Seafood</strong></span>
                  for a better web.
                </div>
              </div>
            </div>
