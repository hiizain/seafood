              ...
              <div class="card z-index-0 fadeIn3 fadeInBottom">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                  <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                    <h4 class="text-white font-weight-bolder text-center mt-0 mb-0">Add Employee</h4>
                </div>
            </div>
            <div class="card-body">
                <form method="POST" action="../process/createemployee.php" role="form" class="text-start" enctype="multipart/form-data">
                    <div class="row my-3">
                      <!-- <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-outline mb-1">
                                <input type="text" placeholder="Name" class="form-control" name="nama_pegawai" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group input-group-outline mb-1">
                            <input type="int" placeholder="Telephone" class="form-control" name="telp_pegawai" required>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="input-group input-group-outline mb-1">
                        ...
                        <div class="col-md-6">
                          <div class="input-group input-group-outline mb-1">
                            <input type="text" placeholder="Address" class="form-control" name="alamat_pegawai" required>
                          </div>
                        </div>
                        <!-- <div class="col-md-6">
                          <div class="input-group input-group-outline mb-1">
