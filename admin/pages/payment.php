              ...
              <table class="table align-items-center table-hover">
                ...
                <?php foreach ($sql as $member) : ?>
                    ...
                    <td class="align-middle text-center text-sm">
                      ...
                      if($member['STATUS_PEMBAYARAN']==2){
                        ?>
                        <span class="text-secondary text-warning font-weight-bold text-xs"><?php echo "Menunggu Konfirmasi"; ?></span>
                        <?php
                      } else if($member['STATUS_PEMBAYARAN']==3){
                        ?>
                        <span class="text-secondary text-success font-weight-bold text-xs"><?php echo "Pembayaran Berhasil"; ?></span>
                        <?php
                      }
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs">Rp. <?php echo $member['TOTAL_PEMBAYARAN']; ?></span>
                    </td>
                    <td>
                      <?php if($member['STATUS_PEMBAYARAN']==2){
                        ?>
                        <a class="btn btn-link text-success text-gradient px-3 mb-0" href="../process/confirmPayment.php?id_pembayaran=<?php echo $member['ID_PEMBAYARAN']; ?>" onclick="return confirm('Apakah Anda yakin ingin mengonfirmasi ini?')"><i class="material-icons opacity-10">credit_card</i> Confirm</a>
                        <?php
                      }?>
                    </td>
                  </tr>
