      ...
      <div class="page-header align-items-start min-vh-100">
        <div class="container my-auto">
          <div class="row">
            ...
            <div class="card-body">
                <form method="POST" action="../process/additem.php" role="form" class="text-start" enctype="multipart/form-data">
                    <input type="hidden" name="id_katalog" id="" value="<?= $id_katalog;?>">
                    <div class="row my-3">
                          <?php
                          foreach($sql as $item){
                          ?>
                          <div class="col-md-6">
                            <input type="checkbox" value="<?= $item["ID_BARANG"] ?>" name="id_barang[]">
