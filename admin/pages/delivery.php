...
$query = "SELECT * FROM pengiriman ORDER BY no_resi ASC LIMIT 0, 10";
$sql = query($query);
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <p style="padding:10pt 0pt 0pt 10pt;">
					<a href="createdelivery.php" class="btn btn-xs btn-primary"><i class="fas fa-fw fa-plus"></i>Add</a>
				</p>
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Delivery table</h6>
              </div>
            </div>            
              ...
              <table class="table align-items-center table-hover">
                ...
                <?php foreach ($sql as $member) : ?>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs"><?php echo $member['NO_RESI']; ?></span>
                    </td>
                    <td class="align-middle text-center text-sm">
