...
$query = "SELECT * FROM pembayaran ORDER BY id_pembayaran ASC LIMIT 0, 10";
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <p style="padding:10pt 0pt 0pt 10pt;">
					<a href="createpayment.php" class="btn btn-xs btn-primary"><i class="fas fa-fw fa-plus"></i>Add</a>
				</p>
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <table class="table align-items-center table-hover">
                ...
                <?php foreach ($sql as $member) : ?>
                    ...
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs"><?php echo $member['tgl_pembayaran']; ?></span>
                    </td>
                    <td>
                      <div class="d-flex py-1">
                        <div>
                          <img src="../assets/bukti-pembayaran/<?php echo $member["bukti_pembayaran"]; ?>" 
                          class="avatar avatar-sm me-3 border-radius-lg" alt="user1">
                        </div>
                      </div>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs"><?php echo $member['jenis_pembayaran']; ?></span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs"><?php echo $member['status_pembayaran']; ?></span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs"><?php echo $member['total_pembayaran']; ?></span>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <span class="text-secondary font-weight-bold text-xs"><?php echo $member['konfirmasi']; ?></span>
                    </td>
                    <td>
                      <a class="btn btn-link text-danger text-gradient px-3 mb-0" href="deletepayment.php?id_pembayaran=<?php echo $member['id_pembayaran']; ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="material-icons text-sm me-2">delete</i>Delete</a>
                      <a class="btn btn-link text-warning px-3 mb-0" href="editpayment.php?id_pembayaran=<?php echo $member['id_pembayaran']; ?>"><i class="material-icons text-sm me-2">edit</i>Edit</a>
                    </td>
                  </tr>
                  <?php endforeach; ?>
                </tbody>
